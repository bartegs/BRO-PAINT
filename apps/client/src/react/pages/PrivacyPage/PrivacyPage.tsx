  ...
  return (
    <article>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            21/21-2137 Gdańsk, świadcząca usługi drogą elektroniczną za
        ...
        <li>
          <p>
            ...
            <a rel="external" href="https://nety.pl/cyberbezpieczenstwo/">
              zaleceń bezpiecznego korzystania z sieci
            </a>
            .
          </p>
        </li>
      ...
      <p>
        ...
        przetwarzane w infrastrukturze usługodawcy zlokalizowanej w obrębie
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            nadzorczego zajmującego się o chroną danych osobowych.
          </p>
        </li>
      </ul>
